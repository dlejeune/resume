...
\name{Daniel}{Le Jeune}
\position{UCT{\enskip\cdotp\enskip}BSc Student{\enskip\cdotp\enskip}Biochemistry{\enskip\cdotp\enskip}Computer Science}
\address{Claremont, Cape Town, South Africa}

\mobile{(+27) 083 953 4591}
\email{daniel.h.lejeune@gmail.com}
...
\makecvfooter
  {\today}
  {Danie H. Le Jeune~~~·~~~Curriculum Vitae}
  {\thepage}
